...
| Problemas de saúde pessoal ou familiar | Membro da equipe fica menos ativo por ter que acompanhar algum familiar ou ele prórpio para tratamento médico | Menos atribuições de responsabilidade a esse membro, reatribuição de atividades entre a equipe e diminuição do escopo da sprint se possível (alteração no cronograma) |
